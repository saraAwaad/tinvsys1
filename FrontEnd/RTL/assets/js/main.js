...
app.run(['$rootScope', '$state', '$stateParams',
    function ($rootScope, $state, $stateParams) {
        ...
        $rootScope.app = {
            name: 'ماليات هندسة', // name of your project
            author: 'وحدة تطوير العمل الاداري بكلية الهندسة - جامعة طنطا', // author's name or company name
            description: 'إدارة الشئون المالية', // brief description
