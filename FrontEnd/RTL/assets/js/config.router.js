...
app.config(['$stateProvider', '$urlRouterProvider', '$controllerProvider', '$compileProvider', '$filterProvider', '$provide', '$ocLazyLoadProvider', 'JS_REQUIRES',
    function ($stateProvider, $urlRouterProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $ocLazyLoadProvider, jsRequires) {
        ...
        $stateProvider.state('app', {
            ...
            .state('app.messages', {
                url: '/messages',
                templateUrl: "assets/views/messages/messages.html",
                resolve: loadSequence('truncate', 'htmlToPlaintext', 'inboxCtrl')
            }).state('app.messages.inbox', {
                url: '/inbox/:inboxID',
                templateUrl: "assets/views/messages/inbox.html",
            ...
            {
                url: "/employees",
                templateUrl: "assets/views/Employees/grid/employee_grid.html",
            ...
            .state('app.purchases.purchasingRequest', {
                url: '/purchasingRequest',
                templateUrl: "assets/views/purchasingRequest/grid/purchasingRequest_grid.html",
                title: 'طلبات الشراء',
                icon: 'ti-layout-media-left-alt',
                ncyBreadcrumb: {
                    label: 'طلبات الشراء'
            ...
            .state('app.purchases.purchasingRequest_insert', {
                url: '/purchasingRequest_insert',
                templateUrl: "assets/views/purchasingRequest/insert/purchasingRequest_insert.html",
                title: 'طلب شراء جديد',
                ncyBreadcrumb: {
                    label: 'طلب شراء جديد'
                }
            })
            .state('app.purchases.purchasingRequest_edit', {
                url: '/purchasingRequest_edit/:Purchase_Request_ID',
                templateUrl: "assets/views/purchasingRequest/edit/purchasingRequest_edit.html",
                title: 'تعديل طلب شراء',
                ncyBreadcrumb: {
                    label: 'تعديل طلب شراء'
                }
            })
            ...
            .state('app.purchases.Quote', {
                url: '/Quote',
                templateUrl: "assets/views/Quote/grid/Quote_grid.html",
                title: 'عروض الاسعار',
                icon: 'ti-layout-media-left-alt',
                ncyBreadcrumb: {
                    label: 'عروض الاسعار'
            ...
            .state('app.purchases.quote_insert', {
                url: '/quote_insert',
                templateUrl: "assets/views/Quote/insert/quote_insert.html",
                title: 'عرض اسعار جديد',
                ncyBreadcrumb: {
                    label: 'عرض اسعار جديد'
                }
            })
            ...
            .state('app.test', {
                ...
                url: '/generalSettings',
                templateUrl: 'assets/views/settings/general/main.html',
                ...
                url: '/units',
                templateUrl: 'assets/views/settings/units/main.html',
                title: 'General Settings',
                ncyBreadcrumb: {
                    label: 'General Settings'
                }
                ...
                url: '/new_unit',
                templateUrl: 'assets/views/settings/units/add.html',
                title: 'General Settings',
                ncyBreadcrumb: {
                    label: 'General Settings'
                }
            ...
            {
                url: "/stocks",
                templateUrl: "assets/views/Stocks/main.html",
                title: "Stocks",
                ncyBreadcrumb: {
                    label: "Stocks"
                }
            })
            .state('app.stockTypes',
            {
                url: "/stockTypes",
                templateUrl: "assets/views/Settings/types/stockTypes/main.html",
                title: "Stock Types",
                ncyBreadcrumb: {
                    label: "Stock Types"
                }
            ...
            {
                url: "/stockDetails",
                templateUrl: "assets/views/Stocks/StockDetails/main.html",
            ...
            {
                url: "/category",
                templateUrl: "assets/views/Category/main.html",
            ...
            {
                url: "/issue",
                templateUrl: "assets/views/Issue/main.html",
            ...
            {
                url: "/issueDetails",
                templateUrl: "assets/views/Issue/IssueDetails/main.html",
            ...
            {
                url: "/items",
                templateUrl: "assets/views/Items/main.html",

                title: "items",
                ncyBreadcrumb: {
                    label: "items"
                }
            }).state('app.lkupItemStatus',
            {
                url: "/lkupItemStatus",
                templateUrl: "assets/views/Items/ItemStatus/main.html",

                title: "lkupItemStatus",
                ncyBreadcrumb: {
                    label: "lkupItemStatus"
                }
            }).state('app.lkupPaymentTypes',
            {
                url: "/lkupPaymentTypes",
                templateUrl: "assets/views/Settings/types/paymentTypes/main.html",

                title: "Payment Types",
                ncyBreadcrumb: {
                    label: "Payment Types"
                }
            }).state('app.lkupReceiptType',
            {
                url: "/lkupReceiptType",
                templateUrl: "assets/views/Settings/types/lkupReceiptType/main.html",

                title: "lkupReceiptType",
                ncyBreadcrumb: {
                    label: "lkupReceiptType"
                }
            }).state('app.lkupUOI',
            {
                url: "/lkupUOI",
                templateUrl: "assets/views/lkupUOI/main.html",
            ...
            {
                url: "/suppliers",
                templateUrl: "assets/views/Suppliers/main.html",

                title: "suppliers",
                ncyBreadcrumb: {
                    label: "suppliers"
                }
            }).state('app.new_supplier',
            {
                url: "/new_supplier",
                templateUrl: "assets/views/Suppliers/add.html",
            ...
            {
                url: "/order",
                templateUrl: "assets/views/Orders/main.html",
            ...
            {
                url: "/orderDetails",
                templateUrl: "assets/views/Orders/OrderDetails/main.html",

                title: "orderDetails",
                ncyBreadcrumb: {
                    label: "orderDetails"
                }
            }).state('app.lkupFinYear',
            {
                url: "/lkupFinYear",
                templateUrl: "assets/views/lkupFinYear/main.html",

                title: "lkupFinYear",
                ncyBreadcrumb: {
                    label: "lkupFinYear"
                }
            }).state('app.new_lkupFinYear',
            {
                url: "/new_lkupFinYear",
                templateUrl: "assets/views/lkupFinYear/add.html",
